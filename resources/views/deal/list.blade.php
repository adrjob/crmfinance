...
@section('action-btn')
    ...
    <a href="{{ route('deal.index') }}" class="btn btn-sm btn-primary btn-icon m-1">
        <i class="ti ti-layout-kanban text-white" data-bs-toggle="tooltip" data-bs-original-title="{{ __('Kanban') }}"></i>

        {{-- <span class="btn-inner--text text-dark">{{__('Kanban')}}</span> --}}
    </a>
    ...
    data-bs-original-title="{{__('Create New Deal')}}">
        ...
        {{-- <a href="#" data-url="{{ route('deal.create') }}" data-size="lg" data-ajax-popup="true" data-title="{{__('Create New Deal')}}" class="btn btn-sm btn-white btn-icon-only rounded-circle" data-toggle="tooltip">
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-auto mb-3 mb-sm-0">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3">
                            <!-- <small class="text-muted">{{ __('Statistics') }}</small>s -->
                                            ...
                                            <div class="action-btn bg-danger ms-2">
                                                <form method="POST" action="{{ route('deal.destroy', $deal->id) }}">
                                                    ...
                                                    <span class="text-white">
                                                        <i class="ti ti-trash" data-bs-toggle="tooltip" data-bs-original-title="{{ __('Delete') }}"></i></span>
                                                    </button>
                                                </form>
                                            </div>
                                            @endif
