    ...
    <div class="form-group row">
        <div class="form-group col-md-12">
            <div class="form-check form-check-inline">
                <input class="form-check-input type" type="radio" name="type" value="Client" {{$noticeBoard->type=='Client'?'checked':''}}
            ...
            <div class="form-check form-check-inline">
                <input class="form-check-input type" type="radio" name="type" value="Employee" {{$noticeBoard->type=='Employee'?'checked':''}}
                    id="customCheckinlh2">
