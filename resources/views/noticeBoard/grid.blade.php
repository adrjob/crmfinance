                    ...
                    <div class="d-flex align-items-center mt-3">
                        <ul class="list-inline">
                            <li class="list-inline-item pr-3" data-toggle="tooltip" data-title="{{__('Assign to')}}">
                                <span class="badge bg-info p-2 px-3 rounded">{{$noticeBoard->type}}</span>
                            </li>
                            <li class="list-inline-item pr-3" data-toggle="tooltip" data-title="{{__('Department')}}">
                                <span class=" badge bg-success p-2 px-3 rounded">{{($noticeBoard->type!='Client') ?($noticeBoard->type=='Employee' && !empty($noticeBoard->departments)?$noticeBoard->departments->name:__('All')):'-'}}</span>
                            </li>
                        </ul>
                    </div>
                </div>
