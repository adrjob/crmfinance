...
{{--                    <li class="dash-item dash-hasmenu  {{ Request::segment(1) == 'expense' ? 'active' : '' }}">--}}
{{--                        <a class="dash-link"--}}
...
{{--                @endif--}}
                ...
                @if (\Auth::user()->type == 'company')
                    <li
                        class=" {{ Request::segment(1) == 'employee' || Request::segment(1) == 'client' ? 'active dash-trigger' : '' }}">
                        ...
                        <ul class="dash-submenu">
                            @foreach($place as $pl)
                                <li class="dash-item dash-hasmenu {{ Request::segment(1) == 'client' ? 'active' : '' }}">
                                    <a class="dash-link"
                                       href="{{ route('expenses.show', $pl->id) }}">{{ $pl->name }}</a>
                                </li>
                            @endforeach
                        </ul>
                    </li>
...
{{--                                    class="ti ti-accessible"></i></span><span--}}
{{--                                class="dash-mtext">{{ __('My Profile') }}</span></a>--}}

{{--                    </li>--}}
{{--                @elseif(\Auth::user()->type == 'client')--}}
{{--                    <li class="dash-item">--}}
{{--                        <a href="{{ route('client.show', \Crypt::encrypt(\Auth::user()->id)) }}"--}}
{{--                            class="dash-link"><span class="dash-micon"><i--}}
...
{{--                                        <li class="dash-item">--}}
{{--                                            <a class="dash-link"--}}
{{--                                                href="{{ route('bulk.attendance') }}">{{ __('Bulk--}}
{{--                                                Attendance') }}</a>--}}
{{--                                        </li>--}}
{{--                                    </ul>--}}
{{--                                </li>--}}
...
{{--                            <li class="dash-item ">--}}
{{--                                <a class="dash-link"--}}
{{--                                    href="{{ route('holiday.index') }}">{{ __('Holiday') }}</a>--}}
{{--                            </li>--}}
{{--                            <li class="dash-item">--}}
...
{{--                            <li class="dash-item">--}}
{{--                                <a class="dash-link"--}}
{{--                                    href="{{ route('account-assets.index') }}">{{ __('Asset') }}</a>--}}
{{--                            </li>--}}
{{--                            <li class="dash-item">--}}
{{--                                <a class="dash-link"--}}
{{--                                    href="{{ route('document-upload.index') }}">{{ __('Document') }}</a>--}}
{{--                            </li>--}}
{{--                            <li class="dash-item">--}}
{{--                                <a class="dash-link"--}}
...
{{--                                    <li class="dash-item">--}}
{{--                                        <a class="dash-link"--}}
{{--                                            href="{{ route('trip.index') }}">{{ __('Trip') }}</a>--}}
{{--                                    </li>--}}
{{--                                    <li class="dash-item">--}}
{{--                                        <a class="dash-link"--}}
...
{{--                            </li>--}}
{{--                            <li class="dash-item dash-hasmenu">--}}
{{--                                <a class="dash-link" href="#">{{ __('Performance') }}<span--}}
{{--                                        class="dash-arrow"><i data-feather="chevron-right"></i></span></a>--}}
{{--                                <ul class="dash-submenu">--}}
{{--                                    <li class="dash-item">--}}
{{--                                        <a class="dash-link"--}}
...
{{--                                <a class="dash-link" href="#">{{ __('Training') }}<span--}}
{{--                                        class="dash-arrow"><i data-feather="chevron-right"></i></span></a>--}}
{{--                                <ul class="dash-submenu">--}}
{{--                                    <li--}}
...
{{--                                    <a class="dash-link"--}}
{{--                                        href="{{ route('estimate.index') }}">{{ __('Estimation') }}</a>--}}
{{--                                </li>--}}
{{--                            @endif--}}
{{--                            @if (\Auth::user()->type == 'company')--}}
{{--                                <li--}}
...
{{--                @if (\Auth::user()->type == 'company')--}}
{{--                    <li class="dash-item">--}}
{{--                        <a href="{{ route('itemstock.index') }}" class="dash-link"><span--}}
...
{{--                @if (\Auth::user()->type == 'company' || \Auth::user()->type == 'client')--}}
{{--                    <li class="dash-item dash-hasmenu {{ Request::segment(1) == 'invoice' || Request::segment(1) == 'payment' || Request::segment(1) == 'creditNote' || Request::segment(1) == 'expense' ? 'active dash-trigger' : '' }}">--}}
{{--                        <a href="#!" class="dash-link"><span class="dash-micon"><i--}}
...
{{--                            class="dash-link"><span class="dash-micon"><i--}}
{{--                                    class="ti ti-businessplan"></i></span><span--}}
...
{{--                            class="dash-link"><span class="dash-micon"><i--}}
{{--                                    class="ti ti-video-plus"></i></span><span--}}
...
{{--                        <a href="#!" class="dash-link {{ (Request::segment(1) == 'chart-of-account'  || Request::segment(1) == 'journal-entry' || Request::segment(2) == 'ledger' ||  Request::segment(2) == 'balance-sheet' ||  Request::segment(2) == 'trial-balance')?'show':''}}"><span class="dash-micon"><i--}}
{{--                                    class="ti ti-forms"></i></span><span--}}
{{--                                class="dash-mtext">{{ __('Double Entry') }}</span><span--}}
{{--                                class="dash-arrow"><i data-feather="chevron-right"></i></span></a>--}}
{{--                        <ul class="dash-submenu">--}}
...
{{--                            class="dash-link"><span class="dash-micon"><i--}}
{{--                                    class="ti ti-headset"></i></span><span--}}
...
{{--                @if (\Auth::user()->type == 'super admin')--}}
{{--                    <li class="dash-item">--}}
{{--                        <a href="{{ route('coupon.index') }}" class="dash-link"><span--}}
{{--                                class="dash-micon"><i class="ti ti-clipboard-check"></i></span><span--}}
...
{{--                                class="dash-mtext">{{ __('Language') }}</span></a>--}}
{{--                    </li>--}}
{{--                @endif -->--}}
{{--                @if (\Auth::user()->type == 'company')--}}
{{--                    <li class="dash-item dash-hasmenu">--}}
...
{{--                            <li class="dash-item">--}}
{{--                                <a class="dash-link"--}}
{{--                                    href="{{ route('report.task') }}">{{ __('Task') }}</a>--}}
{{--                            </li>--}}
{{--                            <li class="dash-item">--}}
{{--                                <a class="dash-link" href="{{route('report.income.expense')}}">{{__('Expense')}}</a>--}}
{{--                            </li>--}}
{{--                            <li class="dash-item">--}}
{{--                                <a class="dash-link"--}}
{{--                                    href="{{ route('report.timelog') }}">{{ __('Time Log') }}</a>--}}
{{--                            </li>--}}
{{--                            <li class="dash-item">--}}
{{--                                <a class="dash-link"--}}
{{--                                    href="{{ route('report.finance') }}">{{ __('Finance') }}</a>--}}
{{--                            </li>--}}
{{--                            <li class="dash-item">--}}
{{--                                <a class="dash-link"--}}
...
{{--                            <li class="dash-item">--}}
{{--                                <a class="dash-link"--}}
{{--                                    href="{{ route('report.estimate') }}">{{ __('Estimate') }}</a>--}}
{{--                            </li>--}}
{{--                            <li class="dash-item">--}}
{{--                                <a class="dash-link"--}}
...
{{--                            <li class="dash-item">--}}
{{--                                <a class="dash-link"--}}
{{--                                    href="{{ route('report.client') }}">{{ __('Client') }}</a>--}}
{{--                            </li>--}}
{{--                            <li class="dash-item">--}}
{{--                                <a class="dash-link"--}}
...
{{--                        <ul class="dash-submenu">--}}
{{--                            <li class="dash-item dash-hasmenu">--}}
{{--                                <a class="dash-link" href="#">{{ __('HR') }}<span--}}
{{--                                        class="dash-arrow"><i data-feather="chevron-right"></i></span></a>--}}
{{--                                <ul class="dash-submenu">--}}
{{--                                    <li class="dash-item">--}}
{{--                                        <a class="dash-link"--}}
...
{{--                            </li>--}}
{{--                            <li class="dash-item dash-hasmenu">--}}
{{--                                <a class="dash-link" href="#">{{ __('PreSale') }}<span--}}
{{--                                        class="dash-arrow"><i data-feather="chevron-right"></i></span></a>--}}
{{--                                <ul class="dash-submenu">--}}
{{--                                    <li class="dash-item">--}}
{{--                                        <a class="dash-link"--}}
...
{{--                                    <li class="dash-item">--}}
{{--                                        <a class="dash-link"--}}
{{--                                            href="{{ route('label.index') }}">{{ __('Label') }}</a>--}}
{{--                                    </li>--}}
{{--                                </ul>--}}
{{--                            </li>--}}
{{--                            <li class="dash-item">--}}
...
{{--                            <li class="dash-item">--}}
{{--                                <a class="dash-link"--}}
{{--                                    href="{{ route('taxRate.index') }}">{{ __('Tax Rate') }}</a>--}}
{{--                            </li>--}}
{{--                            <li class="dash-item">--}}
{{--                                <a class="dash-link"--}}
{{--                                    href="{{ route('unit.index') }}">{{ __('Unit') }}</a>--}}
{{--                            </li>--}}
{{--                            <li class="dash-item">--}}
{{--                                <a class="dash-link"--}}
{{--                                    href="{{ route('category.index') }}">{{ __('Category') }}</a>--}}
...
{{--                @if (\Auth::user()->type == 'company' || \Auth::user()->type == 'employee')--}}
{{--                    <li class="dash-item">--}}
{{--                        <a href="{{ route('event.index') }}" class="dash-link"><span--}}
{{--                                class="dash-micon"><i class="ti ti-calendar-event"></i></span><span--}}
...
{{--                @endif--}}
                ...
                @if (\Auth::user()->type == 'company')
                    <li >
                        <a class="dash-link"
                           href="{{ route('place.index') }}"><span class="dash-micon"><i
                                    class="ti ti-home"></i></span><span
                                class="dash-mtext">{{ __('Place') }}</span></a>
                    </li>

                    <li >
                        <a class="dash-link"
                           href="{{ route('client.index') }}"><span class="dash-micon"><i
                                    class="ti ti-user"></i></span><span
                                class="dash-mtext">{{ __('User') }}</span></a>
                    </li>
                @endif
