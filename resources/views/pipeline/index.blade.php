...
@section('title')
    <div class="d-inline-block">
        <h5 class="h4 d-inline-block font-weight-400 mb-0 ">{{__('Pipeline')}}</h5>
    </div>
@endsection
@section('breadcrumb')
...
@section('action-btn')
    ...
    data-bs-target="#exampleModal" data-url="{{ route('pipeline.create') }}"
    data-bs-whatever="{{__('Create New Pipeline')}}"> <span class="text-white"> 
                                        ...
                                        <td class="text-end">
                                            <div class="action-btn bg-info ms-2">
                                                <a href="#" class="mx-3 btn btn-sm d-inline-flex align-items-center" data-bs-toggle="modal"
                                                    data-bs-target="#exampleModal" data-url="{{ route('pipeline.edit',$pipeline->id) }}"
                                                    data-bs-whatever="{{__('Edit Pipeline')}}"> <span class="text-white"> <i
                                            ...
                                            <div class="action-btn bg-danger ms-2">
                                                ...
                                                {{-- <form method="POST" action="{{ route('pipeline.destroy', $pipeline->id) }}">
                                                    @csrf
