...
@section('action-btn')
    ...
    data-bs-whatever="{{__('Create New Source')}}"> <span class="text-white"> 
        ...
        {{-- <a href="#" data-size="lg" data-url="{{ route('source.create') }}" data-toggle="tooltip" data-ajax-popup="true" data-title="{{__('Create New Source')}}" class="btn btn-sm btn-white btn-icon-only rounded-circle">
