...
@endsection
@section('action-btn')
    <a class="btn btn-sm btn-primary btn-icon m-1" data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample" data-bs-toggle="tooltip"  data-bs-original-title="{{__('Filter')}}">
            ...
            <div class="collapse {{isset($_GET['project'])?'show':''}}" id="collapseExample">
                <div class="card card-body">
                    ...
                    <div class="row filter-css">
                        ...
                        <!-- <div class="col-auto mt-2">
                            <a href="{{route('project.all.timesheet')}}" data-toggle="tooltip" data-title="{{__('Reset')}}" class="btn btn-xs btn-danger btn-icon-only rounded-circle"><i class="ti ti-trash"></i></a>
                        </div> -->
                        <div class="action-btn bg-danger ms-2">
                            <div class="col-auto my-1">
                                <a href="{{route('project.all.timesheet')}}" data-bs-toggle="tooltip" title="{{__('Reset')}}" 
