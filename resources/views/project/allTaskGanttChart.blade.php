                ...
                <div class="card-header actions-toolbar">
                    <div class="row justify-content-between align-items-center">
                        ...
                        {{-- <div class="col text-right">
                            <a href="{{route('project.all.task.gantt.chart','Quarter Day')}}" class="btn btn-xs btn-info gantt-chart-mode  @if($duration == 'Quarter Day')active @endif" data-value="Quarter Day">{{__('Quarter Day')}}</a>
                            <a href="{{route('project.all.task.gantt.chart','Half Day')}}" class="btn btn-xs btn-info gantt-chart-mode @if($duration == 'Half Day')active @endif" data-value="Half Day">{{__('Half Day')}}</a>
                            <a href="{{route('project.all.task.gantt.chart','Day')}}" class="btn btn-xs btn-info gantt-chart-mode @if($duration == 'Day')active @endif" data-value="Day">{{__('Day')}}</a>
                            <a href="{{route('project.all.task.gantt.chart','Week')}}" class="btn btn-xs btn-info gantt-chart-mode @if($duration == 'Week')active @endif" data-value="Week">{{__('Week')}}</a>
                            <a href="{{route('project.all.task.gantt.chart','Month')}}" class="btn btn-xs btn-info gantt-chart-mode @if($duration == 'Month')active @endif" data-value="Month">{{__('Month')}}</a> --}}
                        {{-- </div> --}}
                    </div>
                </div>
                <div class="card-body">
