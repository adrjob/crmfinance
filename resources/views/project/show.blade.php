                    ...
                    <div class="dropdown-menu">
                        @foreach ($projectStatus as $k => $status)
                            <a class="dropdown-item status" data-id="{{ $k }}"
                                data-url="{{ route('project.status', $project->id) }}" href="#">{{ $status }}</a>
                        @endforeach
                    </div>
                </div>
            @endif
                                            ...
                                            <div class="col-md-4 col-sm-6">
                                                <div class="d-flex align-items-start">
                                                    ...
                                                    <div class="ms-2">
                                                        ...
                                                        <p class="mb-0 text-warning">{{ count($project->projectUser()) }}
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        @if (\Auth::user()->type == 'company')
                                            <p class="text-muted d-none d-sm-flex align-items-center mb-0">
                                                <a href="#" class="btn btn-sm btn-primary btn-icon m-1"
                                                    ...
                                                    data-bs-whatever="{{ __('Add User') }}"> <span class="text-white">
                                                ...
                                                <div class="col-4">
                                                    <div class="card">
                                                        <div class="card-header">
                                                            <div class="float-end">
                                                                <button
                                                                    class="btn btn-sm btn-primary btn-icon task-header">
                                                                    <span
                                                                        class="count text-white">{{count($tasks)}}</span>
                                                                </button>
                                                            </div>
                                                            <h4 class="mb-0">{{$stage->name}}</h4>
                                                        </div>
                                                                ...
                                                                <div class="card" data-id="{{$task->id}}">
                                                                    <div class="pt-3 ps-3">
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <h5>
                                                                                <a href="#" data-url="{{ route('project.task.show',$task->id) }}" data-toggle="modal" data-bs-target="#exampleModal"
                                                                                    ...
                                                                                    <div
                                                                                        class="dropdown-menu dropdown-menu-end">
                                                                                            ...
                                                                                            @if (\Auth::user()->type == 'company')
                                                                                                <span
                                                                                                    class="dropdown-item">
                                                                                                    {!! Form::open(['method' => 'DELETE', 'route' => ['project.task.destroy', $task->id], 'id' => 'delete-form-' . $task->id]) !!}
                                                                                                    <a href="#!"
                                                                                                        class=" show_confirm">
                                                                                                        <i
                                                                        ...
                                                                        <div class="card-body">
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <ul class="list-inline mb-0 mt-3">
                                                                                    ...
                                                                                    class="list-inline-item d-inline-flex align-items-center">
                                                                                    <i
                                                                                        class="f-16 text-primary ti ti-discount"></i> {{$task->taskCompleteCheckListCount()}}/{{$task->taskTotalCheckListCount()}}
                                                                                </li>
                                                                                <li
                                        ...
                                        <tbody>
                                            @foreach ($files as $file)
                                                <tr>
                                                        ...
                                                        <div class="media align-items-center">
                                                            <div class="media-body user-group1">
                                                                <img alt="Image placeholder"
                                                                    src="{{ asset(Storage::url('uploads/files')) . '/' . $file->file }}"
                                                                    class=""><br>
                                                            </div>
                                                        </div>
                                                    </th>
                                                    ...
                                                    <td class="text-end">
                                                        <div class="action-btn bg-warning ms-2">
                                                            <a href="{{ asset(Storage::url('uploads/files')) . '/' . $file->file }}"
                                                                class="mx-3 btn btn-sm d-inline-flex align-items-center"
                                                                data-bs-toggle="tooltip" download=""
                                                                data-original-title="{{ __('Download') }}">
                                                                <i class="ti ti-arrow-bar-to-down text-white" data-bs-toggle="tooltip" data-bs-original-title="{{ __('Download') }}"></i>
                                                            </a>
                                                        </div>
                            ...
                            <div class="card-body">
                                @foreach ($comments as $comment)
                                    <div class="media mb-2">
                                        ...
                                        <div class="media-body">
                                            <h6 class="mt-0 ms-2">
                                                {{ !empty($comment->commentUser) ? $comment->commentUser->name : '' }} <small
                                                ...
                                                @if (!empty($comment->file))
                                                    <div class="action-btn bg-warning ms-2">
                                                        <a href="#" class="like active">
                                                            ...
                                                            <a href="{{ asset(Storage::url('uploads/files')) . '/' . $comment->file }}"
                                                                download=""
                                                                class="mx-3 btn btn-sm d-inline-flex align-items-center"
                                                ...
                                                <div class="media mt-3">
                                                    ...
                                                    <div class="media-body">
                                                        ...
                                                        @if (!empty($subComment->file))
                                                            <div class="action-btn bg-warning ms-2">
                                                                <a href="{{ asset(Storage::url('uploads/files')) . '/' . $subComment->file }}"
                                ...
                                <div class="border rounded mt-4">
                                    ...
                                    <textarea rows="3" class="form-control border-0 resize-none" name="comment" placeholder="Your comment..."
                                        required></textarea>
