...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="collapse {{isset($_GET['date'])?'show':''}}" id="collapseExample">
                <div class="card card-body">
                    ...
                    <div class="row filter-css">
                        ...
                        <div class="action-btn bg-danger ms-2">
                            <div class="col-auto my-1">
                                <a href="{{route('attendance.index')}}" data-bs-toggle="tooltip" title="{{__('Reset')}}" 
                                ...
                                @if(\Auth::user()->type=='company')
                                    <td class="text-right">
                                        <div class="action-btn bg-info ms-2">
                                            ...
                                            data-bs-target="#exampleModal" data-url="{{ route('attendance.edit',$attendance->id) }}"
                                            data-bs-whatever="{{__('Edit Attendance')}}" title="Edit Attendance" 
                                            > <span class="text-white"> <i
                                                    class="ti ti-edit" data-bs-toggle="tooltip" data-bs-original-title="{{__('Edit Attendance')}}"></i></span></a>
                                        </div>
                                        ...
                                        {{-- <a href="#" class="action-item" data-url="{{ route('attendance.edit',$attendance->id) }}" data-ajax-popup="true" data-title="{{__('Edit Attendance')}}" data-toggle="tooltip" data-original-title="{{__('Edit')}}">
                                            <i class="fas fa-edit"></i>
                                        </a>
    
                                        <a href="#!" class="action-item" data-toggle="tooltip" data-original-title="{{__('Delete')}}" data-confirm="Are You Sure?|This action can not be undone. Do you want to continue?" data-confirm-yes="document.getElementById('delete-form-{{$attendance->id}}').submit();">
