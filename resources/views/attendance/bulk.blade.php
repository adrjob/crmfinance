            ...
            <div class="collapse {{isset($_GET['department'])?'show':''}}" id="collapseExample">
                <div class="card card-body">
                    ...
                    <div class="row filter-css">
                        ...
                        <div class="col-md-3">
                            {{ Form::select('department', $department,isset($_GET['department'])?$_GET['department']:'', array('class' => 'form-control','data-toggle="select"','required')) }}
                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="row">
                                            ...
                                            <div class="col-md-9 present_check_in {{ empty($attendance) ? 'd-none' : '' }} ">
                                                <div class="row">
