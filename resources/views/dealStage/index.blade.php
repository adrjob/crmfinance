...
<script src="{{ asset('custom_assets/js/jquery-ui.min.js') }}"></script>
                                ...
                                <ul class="list-group sortable">
                                    @foreach ($pipeline['deal_stages'] as $deal_stages)
                                        <li class="list-group-item" data-id="{{$deal_stages->id}}">
                                            <span class="text-xl text-dark">{{$deal_stages->name}}</span>
                                ...
                                <li class="list-group-item" data-id="{{$deal_stages->id}}">
                                    ...
                                    @if(\Auth::user()->type=='company')
                                        <span class="float-right">
                                            <a href="#" data-url="{{ route('dealStage.edit',$deal_stages->id) }}" data-ajax-popup="true" data-title="{{__('Edit Deal Stage')}}" class="action-item" data-toggle="tooltip" data-original-title="{{__('Edit')}}">
                                                <i class="far fa-edit"></i>
                                            </a>
                                            <a href="#!" class="action-item" data-toggle="tooltip" data-original-title="{{__('Delete')}}" data-confirm="Are You Sure?|This action can not be undone. Do you want to continue?" data-confirm-yes="document.getElementById('delete-form-{{$deal_stages->id}}').submit();">
