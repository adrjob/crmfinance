    ...
    <div class="form-group col-md-12">
        ...
        <div class="btn-group btn-group-toggle btn-group-colors event-tag mb-0" data-toggle="buttons">
            <label class="btn bg-info active mr-2 event-color">
                <input type="radio" name="color" value="event-info" autocomplete="off" checked style="display: none; ">
            </label>
            ...
            <!-- <label class="btn bg-success mr-2 event-color">
                <input type="radio" name="color" value="event-success" autocomplete="off" style="display: none">
            </label> -->
