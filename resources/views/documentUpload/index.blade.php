                            ...
                            <tr>
                                <td>
                                    @if(!empty($document->document))
                                        <a class="btn btn-sm btn-secondary btn-icon rounded-pill" href="{{$documentPath.'/'.$document->document}}" target="_blank" download="">
                                ...
                                <td class="text-right">
                                    ...
                                    <div class="action-btn bg-danger ms-2">
                                        ...
                                        {{-- <form method="POST" action="{{ route('document-upload.destroy', $document->id) }}">
                                            @csrf
