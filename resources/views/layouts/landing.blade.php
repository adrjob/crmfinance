        ...
        <div class="row align-items-center justify-content-between">
            <div class="col-sm-5">
                ...
                <h2
                    ...
                    data-wow-delay="0.4s"
                >
                  {{ __('Projects, Accounting, Leads, Deals & HRM Tool
                  ') }}</h2>
                ...
                <div class="my-4 wow animate__fadeInLeft" data-wow-delay="0.8s">
                    <a href="https://demo.rajodiya.com/crmgo/" class="btn btn-light me-2"
                    ><i class="far fa-eye me-2"></i>{{ __('Live Demo') }}</a
                    >
                    <a href="https://codecanyon.net/item/crmgo-projects-accounting-leads-deals-hrm-tool/28619614" class="btn btn-outline-light" target="_blank"
                    ><i class="fas fa-shopping-cart me-2"></i>{{ __('Buy now') }}</a
                    >
                </div>
            </div>
            <div class="col-sm-5">
...
<section id="dashboard" class="theme-alt-bg dashboard-block">
    <div class="container">
        ...
        <div class="row align-items-center justify-content-center pb-5 mobile-screen">
            <div class="col-auto">
        ...
        <img
            src="{{asset(Storage::url('landing/dashboard.png'))}}"
            alt=""
        ...
        <div class="row align-items-center justify-content-end mb-5">
            <div class="col-sm-4">
                ...
                <h2 class="mb-sm-4 wow animate__fadeInLeft" data-wow-delay="0.4s">
                    {{ __('Projects, Accounting, Leads,')}} <br>
                   {{__('Deals & HRM Tool') }}
                ...
                <div class="my-4 wow animate__fadeInLeft" data-wow-delay="0.8s">
                    <a href="https://codecanyon.net/item/crmgo-projects-accounting-leads-deals-hrm-tool/28619614" class="btn btn-primary" target="_blank"
...
<section class="">
    <div class="container">
        <div class="row align-items-center justify-content-end mb-5">
            ...
            <div class="col-sm-6">
                <img
                    src="{{asset(Storage::url('landing/img-crm-dash-3.svg'))}}"
                    alt="Datta Able Admin Template"
                    class="img-fluid header-img wow animate__fadeInRight"
                    data-wow-delay="0.2s"
                />
            ...
            <div class="col-xl-9 col-lg-6 col-md-12 col-sm-12">
                <div class="row feature-img-row m-auto">
                    <div class="col-lg-3 col-sm-6">
                        <img
                        src="{{asset(Storage::url('landing/dashboard.png'))}}"
                            class="img-fluid header-img wow animate__fadeInRight pb-5"
                            data-wow-delay="0.2s"
                            alt="Admin"
                        />
                    </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <img
                            src="{{asset(Storage::url('landing/deal.png'))}}"
                            class="img-fluid header-img wow animate__fadeInRight"
                            data-wow-delay="0.6s"
                            alt="Admin"
                        />
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <img
                            src="{{asset(Storage::url('landing/chart_of_accounts.png'))}}"
                            class="img-fluid header-img wow animate__fadeInRight"
                            data-wow-delay="0.8s"
                            alt="Admin"
                        />
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <img
                            src="{{asset(Storage::url('landing/budget.png'))}}"
                            class="img-fluid header-img wow animate__fadeInRight"
                            data-wow-delay="0.3s"
                            alt="Admin"
                        />
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <img
                            src="{{asset(Storage::url('landing/expense.png'))}}"
                            class="img-fluid header-img wow animate__fadeInRight"
                            data-wow-delay="0.5s"
                            alt="Admin"
                        />
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <img
                            src="{{asset(Storage::url('landing/form_builder.png'))}}"
                            class="img-fluid header-img wow animate__fadeInRight"
                            data-wow-delay="0.7s"
                            alt="Admin"
                        />
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <img
                            src="{{asset(Storage::url('landing/timelog_report.png'))}}"
                            class="img-fluid header-img wow animate__fadeInRight"
                            data-wow-delay="0.9s"
                            alt="Admin"
                        />
