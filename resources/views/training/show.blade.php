                    ...
                    <div class="row align-items-center">
                        <div class="col-auto">
                            <a href="#" class="avatar rounded-circle">
                                <img @if(!empty($training->employees) && !empty($training->employees->avatar)) src="{{asset(Storage::url('uploads/avatar')).'/'.$training->employees->avatar}}" @else avatar="{{ !empty($training->employees)?$training->employees->name:'' }}" @endif class="avatar  rounded-circle avatar-md">
                            </a>
                        </div>
