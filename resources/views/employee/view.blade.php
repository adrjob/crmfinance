...
@section('title')
    <div class="d-inline-block">
        <h5 class="h4 d-inline-block font-weight-400 mb-0">   {{\Auth::user()->employeeIdFormat($employee->employee_id).' '.__('Details')}}</h5>
    </div>
@endsection
@section('breadcrumb')
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item px-0">
                            <div class="row align-items-center">
                                ...
                                <div class="col-6 text-right">
                                {{\Auth::user()->dateFormat($employee->dob)}}
                                </div>
                            </div>
                        </li>
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item px-0">
                            <div class="row align-items-center">
                                ...
                                <div class="col-6 text-right">
                                    {{\Auth::user()->dateFormat($employee->joining_date)}}
                                </div>
                            </div>
                        </li>
                        <li class="list-group-item px-0">
                            <div class="row align-items-center">
                                ...
                                <div class="col-6 text-right">
                                    {{($employee->exit_date!='0000-00-00')?\Auth::user()->dateFormat($employee->exit_date):'-'}}
                                </div>
                            </div>
                        </li>
                        <li class="list-group-item px-0">
