...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active" aria-current="page"><a href="{{route('chart-of-account.index')}}"> {{__('Chart of account')}}</a></li>
        ...
        <div class="col-12">
            <div class="collapse {{isset($_GET['employee'])?'show':''}}" id="collapseExample">
                <div class="card card-body">
                    ...
                    <div class="row">
                        <div class="col-auto filter-css col-lg-3">
                        ...
                        <div class="all-select-box col-3">
                            <div class="btn-box">
                        ...
                        <!-- <div class="col-3 mt-4">
                            <a href="#" class="btn btn-sm btn-info btn-icon m-1" onclick="document.getElementById('report_ledger').submit(); return false;" data-toggle="tooltip" data-original-title="{{__('apply')}}">
                                <span class="btn-inner--icon"><i class="ti ti-search"></i></span>
                            </a>
                            <a href="{{route('report.ledger')}}" class="btn btn-sm btn-danger btn-icon m-1" data-toggle="tooltip" data-original-title="{{__('Reset')}}">
                                <span class="btn-inner--icon"><i class="ti ti-trash"></i></span>
                            </a>
                            <a href="#" class="btn btn-sm btn-warning btn-icon m-1" onclick="saveAsPDF()" data-toggle="tooltip" data-original-title="{{__('Download')}}">
