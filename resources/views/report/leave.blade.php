...
@section('action-btn')
    <a class="btn btn-sm btn-primary btn-icon m-1" data-bs-toggle="collapse" href="#collapseExample" role="button"
        ...
        <i data-bs-toggle="tooltip" title="{{ __('Filter') }}" class="ti ti-filter"></i>
    </a>
...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="collapse {{ isset($_GET['type']) ? 'show' : '' }}" id="collapseExample">
                <div class="card card-body">
                    ...
                    <div class="row filter-css">
                        <div class="col-auto">
                            <div class="row">
                                <div class="btn-group btn-group-toggle" data-toggle="buttons"
                                    ...
                                    <label
                                        class="btn btn-secondary month-label {{ isset($_GET['type']) && $_GET['type'] == 'monthly' ? 'active' : '' }}">
                                        <input type="radio" name="type" value="monthly" class="btn-check monthly"
                                            {{ isset($_GET['type']) && $_GET['type'] == 'monthly' ? 'checked' : '' }}>
                                        {{ __('Monthly') }}
                                    </label>

                                    <label
                                        class="btn btn-secondary year-label {{ isset($_GET['type']) && $_GET['type'] == 'yearly' ? 'active' : '' }}">
                                        <input type="radio" name="type" value="yearly" class="btn-check yearly"
                        ...
                        <div class="col-md-2 year d-none">
                            <select class="form-control" data-toggle="select" id="year" name="year" tabindex="-1"
                                aria-hidden="true">
                        ...
                        <div class="action-btn bg-danger ms-2">
                            <div class="col-auto">
                                <a href="{{ route('report.leave') }}" data-bs-toggle="tooltip" title="{{ __('Reset') }}"
                ...
                <div class="row">
                    ...
                    <div class="col-xxl-6">
                        <div class="card">
                            <div class="card-body">
                                <input type="hidden"
                                    value="{{ $filterYear['dateYearRange'] .' ' .$filterYear['type'] .' ' .__('Leave Report of') .' ' .$filterYear['department'] .' ' .'Department' }}"
                                    id="filename">
                            ...
                            <div class="card-header card-body table-border-style">
                                <!-- <h5> -->
                                    <!-- <div class="card-body table-border-style"> -->
                                        <button class="btn btn-light-primary btn-sm csv">{{ __('Export CSV') }}</button>
                                        <button
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#!"
                                                            ...
                                                            data-bs-whatever="{{ __('Approved Leave Detail') }}"
                                                            data-title="{{ __('Approved Leave Detail') }}" data-size='lg'
                                                            data-toggle="tooltip"
                                                            data-original-title="{{ __('View') }}">
                                                            <span
                                                                class="badge bg-success p-2 px-3 rounded">{{ $leave['approved'] }}</span>
                                                            <i class="ti ti-eye"></i>
                                                        </a>
                                                    </td>
                                                    <td>
                                                        <a href="#!"
                                                            ...
                                                            class="table-action table-action-delete" data-bs-toggle="modal"
                                                            data-bs-target="#exampleModal"
                                                            data-bs-whatever="{{ __('Rejected Leave Detail') }}"
                                                            data-size='lg'
                                                            data-toggle="tooltip"
                                                            data-original-title="{{ __('View') }}">
                                                            <span
                                                                class="badge bg-danger p-2 px-3 rounded">{{ $leave['reject'] }}</span>
                                                            <i class="ti ti-eye"></i>
                                                        </a>
                                                    </td>
                                                    <td>
                                                        <a href="#!"
                                                            ...
                                                            class="table-action table-action-delete" data-bs-toggle="modal"
                                                            data-bs-target="#exampleModal"
                                                            data-bs-whatever="{{ __('ending Leave Detail') }}"
                                                             data-size='lg'
                                                            data-toggle="tooltip"
                                                            data-original-title="{{ __('View') }}">
                                                            <span
                                                                class="badge bg-warning p-2 px-3 rounded">{{ $leave['pending'] }}</span>
                                                            <i class="ti ti-eye"></i>
                                                        </a>
                                                    </td>
                                                </tr>
