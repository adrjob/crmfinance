...
@endsection
@section('action-btn')
    <a class="btn btn-sm btn-primary btn-icon m-1" data-bs-toggle="collapse" href="#collapseExample" 
                    ...
                    <div class="row filter-css">
                        ...
                        <div class="action-btn bg-info ms-2">
                            <div class="col-auto">
                                ...
                                data-bs-toggle="tooltip" title="{{__('Apply')}}"><i class="ti ti-search text-white"></i></button>
                            </div>
                        </div>
                        <div class="action-btn bg-danger ms-2">
                            <div class="col-auto">
                                <a href="{{route('report.task')}}" data-bs-toggle="tooltip" title="{{__('Reset')}}" 
