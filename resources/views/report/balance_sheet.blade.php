...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active" aria-current="page">{{__('Balance Sheet')}}</li>
@endsection
    ...
    <div class="row d-flex justify-content-end">
        ...
        <div class="col-auto mt-4">
            <div class="action-btn bg-info ms-2">
                <a href="#" class="btn btn-sm btn-white btn-icon-only rounded-circle"  onclick="document.getElementById('report_bill_summary').submit(); return false;" data-bs-toggle="tooltip" data-bs-original-title="{{__('apply')}}">
                    <span class="btn-inner--icon"><i class="ti ti-search text-white"></i></span>
                </a>
            </div>
            <div class="action-btn bg-danger ms-2">
                <a href="{{route('report.balance.sheet')}}" class="btn btn-sm btn-white btn-icon-only rounded-circle" data-bs-toggle="tooltip" data-bs-original-title="{{__('Reset')}}">
                    <span class="btn-inner--icon"><i class="ti ti-trash-off text-white"></i></span>
                </a>
            </div>
            <div class="action-btn bg-secondary ms-2">
                <a href="#" class="btn btn-sm btn-white btn-icon-only rounded-circle" onclick="saveAsPDF()" data-bs-toggle="tooltip" data-bs-original-title="{{__('Download')}}">
    ...
    <div id="printableArea">
        <div class="row mt-4">
            <div class="col">
                ...
                <div class="card p-4 mb-4">
                    ...
                    <h7 class="report-text mb-0">{{__('Balance Sheet')}}</h7>
                </div>
            </div>
        ...
        <div class="row">
            @foreach($chartAccounts as $type => $accounts)
                ...
                <div class="col">
                    <div class="card p-4 mb-4">
                        <h6 class="report-text gray-text mb-0">{{__('Total'.' '.$type)}}</h6>
