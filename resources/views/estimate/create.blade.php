                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        {{ Form::select('client', $clients,'', array('class' => 'form-control multi-select','required'=>'required')) }}
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                        ...
                        <div class="card-header border-0">
                            <div class="row">
                                ...
                                <div class="col-6 text-end">
                                    <a href="#"  data-repeater-create=""  title="{{ __('Create New Estimatioon Item') }}" 
                        ...
                        <div class="table">
                            <table class="table align-items-center table-flush" data-repeater-list="items">
                                ...
                                <tr data-repeater-item>
                                    <td width="25%">
                                        {{ Form::select('item', $items,null, array('class' => 'form-control item','data-url'=>route('estimate.product'),'required'=>'required')) }}
                                    </td>
                                    <td>
                                        <div class="form-group">
