            ...
            <div class="invoice-preview-inner">
                <div class="editor-content">
                    <div class="preview-main client-preview">
                        <div data-v-4b3dcb8a="" class="d" style="width:785px;margin-left: 0;margin-right: auto;" id="boxes">
                            <div data-v-4b3dcb8a="" class="d-inner" style="border-top: 15px solid {{$color}};">
                                <div data-v-4b3dcb8a="" class="row">
                                    ...
                                    <div data-v-4b3dcb8a="" class="col-2 text-right">
                                        <img data-v-4b3dcb8a="" src="{{ asset(Storage::url('uploads/logo/'.$logo)) }}" class="d-logo" style="max-width: 250px"></div>
                                </div>
