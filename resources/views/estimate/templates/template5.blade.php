            ...
            <div class="invoice-preview-inner">
                <div class="editor-content">
                    <div class="preview-main client-preview">
                        <div data-v-e23d9750="" class="d" style="width:785px;margin-left: 0;margin-right: auto;" id="boxes">
                                ...
                                <div data-v-e23d9750="" class="row">
                                    <div data-v-e23d9750="" class="col-33">
                                        <table data-v-e23d9750="" class="summary-table">
                                            ...
                                            <tr class="ml-8" style="position: absolute;right: -467px;top: -55px;">
                                                <td class="">
                                                    <p>  {!! DNS2D::getBarcodeHTML(route('pay.invoice',\Illuminate\Support\Facades\Crypt::encrypt($estimate->id)), "QRCODE",2,2) !!}
                                                    </p>
                                                </td>
                                            </tr>
                                            </tbody>
