            ...
            <div class="invoice-preview-inner">
                <div class="editor-content">
                    <div class="preview-main client-preview">
                        <div data-v-7d9d14b5="" class="d" style="width:785px;margin-left: 0;margin-right: auto;" id="boxes">
                            <div data-v-7d9d14b5="" class="d-inner" style="border-right: 50px solid {{$color}};">
                                <div data-v-7d9d14b5="" class="row">
                                    <div data-v-7d9d14b5="" class="col-2"><h1 data-v-7d9d14b5="" class="fancy-title tu mb5" style="color: {{$color}};">{{__('ESTIMATE')}}</h1>
                                        <h3 data-v-7d9d14b5="">{{\App\Models\Utility::estimateNumberFormat($settings,$estimate->estimate)}}</h3>
                                        <p data-v-7d9d14b5="">{{\App\Models\Utility::dateFormat($settings,$estimate->issue_date)}}</p>
                                        <p class="ml-8" style="position: absolute; right: 0;">  {!! DNS2D::getBarcodeHTML(route('pay.invoice',\Illuminate\Support\Facades\Crypt::encrypt($estimate->id)), "QRCODE",2,2) !!}</p>
                                    </div>
                                    <div data-v-7d9d14b5="" class="col-2 text-right"><img data-v-7d9d14b5="" class="d-logo" src="{{ asset(Storage::url('uploads/logo/'.$logo)) }}" style="max-width: 250px;"></div>
                                </div>
