...
<div class="container">
    <div id="app" class="content overflow-x-hidden">
        <div class="editor">
            <div class="invoice-preview-inner">
                <div class="editor-content">
                    <div class="preview-main client-preview">
                        <div data-v-b8f60a0c="" class="d" style="width:785px;margin-left: 0;margin-right: auto;" id="boxes">
                            <div data-v-b8f60a0c="" class="d-inner">
                                <div data-v-b8f60a0c="" class="row">
                                    ...
                                    <div data-v-b8f60a0c="" class="col-33"><img data-v-b8f60a0c="" style="max-width: 250px;" class="d-logo" src="{{ asset(Storage::url('uploads/logo/'.$logo)) }}"></div>
                                </div>
                                    ...
                                    <div data-v-b8f60a0c="">
                                        <table data-v-b8f60a0c="" class="summary-table">
                                            ...
                                            <tr data-v-363339a0="">
                                                ...
                                                <td data-v-363339a0="" class="text-right">{{\App\Models\Utility::estimateNumberFormat($settings,$estimate->estimate)}}</td>
                                            </tr>
                                            <tr data-v-363339a0="">
                                                <td data-v-363339a0="" class="tu fwb" style="color: {{$color}};">{{__('Issue Date')}}:</td>
                                                <td data-v-363339a0="" class="text-right">{{\App\Models\Utility::dateFormat($settings,$estimate->issue_date)}}</td>
                                            </tr>
                                ...
                                <div class="row">
                                    ...
                                    <div class="ship_to">
                                        {{-- <p data-v-363339a0=""  class="ml-8" style="position: absolute; right: 0;">
                                            <td data-v-363339a0="" class="ml-8" style="position: absolute; right: 0;">
                                                <p>{!! DNS1D::getBarcodeHTML(\Auth::user()->estimatenumberFormat($estimate->estimate), "C128",1.4,22) !!}</p>
                                            </td>
                                        </tr> --}}
                                        <p data-v-f2a183a6="">  {!! DNS2D::getBarcodeHTML(route('pay.invoice',\Illuminate\Support\Facades\Crypt::encrypt($estimate->id)), "QRCODE",2,2) !!}</p>
                                ...
                                <div data-v-363339a0="" class="d-table">
                                    <div data-v-363339a0="" class="d-table">
                                        ...
                                        <div class="d-table-tr" style="border-bottom:1px solid {{$color}};">
                                            ...
                                            <div class="d-table-td w-3">
                                                <pre data-v-f2a183a6="">{{\App\Models\Utility::priceFormat($settings,$estimate->totalRate)}}</pre>
                                            </div>
                                            <div class="d-table-td w-6">
                                                <pre data-v-f2a183a6="">{{\App\Models\Utility::priceFormat($settings,$estimate->totalTaxPrice) }}</pre>
                                            </div>
                                            @if($estimate->discount_apply==1)
                                                <div class="d-table-td w-3">
                                                    <pre data-v-f2a183a6="">{{\App\Models\Utility::priceFormat($settings,$estimate->totalDiscount)}}</pre>
                                                </div>
                                            @else
                                                <div class="d-table-td w-3">
                                                    <pre data-v-f2a183a6="">-</pre>
                                            ...
                                            <div class="d-table-td w-4 text-right">
                                                    <span>{{\App\Models\Utility::priceFormat($settings,$estimate->getSubTotal())}}
                                                    </span>
                                            </div>
                                        </div>
                                        <div data-v-f2a183a6="" class="d-table-footer">
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-summary">
                                                @if($estimate->discount_apply==1)
                                                    @if($estimate->getTotalDiscount())
                                                        <div data-v-f2a183a6="" class="d-table-summary-item">
                                                            ...
                                                            <div data-v-f2a183a6="" class="d-table-value">{{\App\Models\Utility::priceFormat($settings,$estimate->getTotalDiscount())}}</div>
                                                        </div>
                                                    @endif
                                                @endif
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-summary-item" style="color: {{$font_color}}; background: {{$color}};">
                                                    ...
                                                    <div data-v-f2a183a6="" class="d-table-value">{{\App\Models\Utility::priceFormat($settings,$estimate->getSubTotal()-$estimate->getTotalDiscount()+$estimate->getTotalTax())}}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
