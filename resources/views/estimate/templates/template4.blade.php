            ...
            <div class="invoice-preview-inner">
                <div class="editor-content">
                    <div class="preview-main client-preview">
                        <div data-v-363339a0="" class="d" style="width:785px;margin-left: 0;margin-right: auto;" id="boxes">
                            <div data-v-363339a0="" class="d-inner">
                                <div data-v-363339a0="" class="row">
                                    ...
                                    <div data-v-363339a0="" class="col-2 text-right">
                                        <img data-v-363339a0="" src="{{ asset(Storage::url('uploads/logo/'.$logo)) }}" style="max-width: 250px" class="d-logo">
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div data-v-363339a0="" class="col-1 text-right">
                                        <div data-v-363339a0="" class="">
                                            <table data-v-363339a0="" class="summary-table">
                                                ...
                                                <tr class="ml-8" style="position: absolute;right: 576px;top: -44px;">
                                                    <td class="">
