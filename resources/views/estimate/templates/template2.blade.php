            ...
            <div class="invoice-preview-inner">
                <div class="editor-content">
                    <div class="preview-main client-preview">
                        <div data-v-37eeda86="" class="d" style="width:785px;margin-left: 0;margin-right: auto;" id="boxes">
                            <div data-v-37eeda86="" class="d-inner">
                                <div data-v-37eeda86="" class="row">
                                    <div data-v-37eeda86="" class="col-2">
                                        <img src="{{ asset(Storage::url('uploads/logo/'.$logo)) }}" style="max-width: 250px"/>
                                    </div>
                                ...
                                <div data-v-37eeda86="">
                                    ...
                                    <table data-v-37eeda86="" class="summary-table">
                                        ...
                                        <tr data-v-363339a0="">
                                            ...
                                            <td data-v-363339a0="" class="text-right">{{\App\Models\Utility::dateFormat($settings,$estimate->due_date)}}</td>
                                        </tr>
                                        <tr class="ml-8" style="position: absolute; right: 0;">
                                            <td class="">
                                                <p>  {!! DNS2D::getBarcodeHTML(route('pay.invoice',\Illuminate\Support\Facades\Crypt::encrypt($estimate->id)), "QRCODE",2,2) !!}</p>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
