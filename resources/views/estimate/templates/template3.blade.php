            ...
            <div class="invoice-preview-inner">
                <div class="editor-content">
                    <div class="preview-main client-preview">
                        <div data-v-e95a8a8c="" class="d" style="width:785px;margin-left: 0;margin-right: auto;" id="boxes">
                            <div data-v-e95a8a8c="" class="d-inner">
                                <div data-v-e95a8a8c="" class="row">
                                    ...
                                    <div data-v-e95a8a8c="" class="col-2 text-right">
                                        <img data-v-e95a8a8c="" src="{{ asset(Storage::url('uploads/logo/'.$logo)) }}" style="max-width: 250px" class="d-logo"></div>
                                </div>
