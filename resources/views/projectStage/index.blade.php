...
@section('action-btn')
    ...
    data-bs-target="#exampleModal" data-url="{{ route('projectStage.create') }}"
    data-bs-whatever="{{__('Create New Project Stage')}}"> <span class="text-white"> 
                            ...
                            @if(\Auth::user()->type=='company')
                                <span class="float-end">
                                    <div class="action-btn bg-info ms-2">
                                        ...
                                        data-url="{{ route('projectStage.edit',$project_stages->id) }}"
                                        data-bs-toggle="modal" data-bs-target="#exampleModal"  data-bs-whatever="{{__('Edit Project Stage')}}" 
                                        data-size="md">
