...
<div class="d-inline-block">
    <h5 class="h4 d-inline-block font-weight-400 mb-0">{{__('Edit Budget Planner')}}</h5>
</div>
...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active" aria-current="page"> <a href="{{ route('budget.index') }}"> {{ __('Budget Plannner') }}</a></li>
    <li class="breadcrumb-item active" aria-current="page"> <a href="#"> {{ __('Budget Plannner Edit') }}</a></li>
@endsection
...
<div class="card">
    ...
    <div class="row">
        ...
        {{-- <div class="form-group  col-md-6">
            ...
            {{ Form::month('to',null, array('class' => 'form-control custom-monthpicker')) }}
        </div> --}}
    </div>
    </div>
</div>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="table-responsive budget_plan d-block"  id="monthly">
                ...
                <div class="modal-footer pr-0 mt-2 me-2">
