        ...
        <div class="col-auto">
            <div class="actions">
                ...
                @else
                    <div class="action-btn bg-warning ms-2">
                        <a href="#" data-url="{{ route('lead.convert.deal', $lead->id) }}" data-size="lg"
                            ...
                            class="mx-3 btn btn-sm d-inline-flex align-items-center">
                            <i class="ti ti-exchange text-white" data-bs-toggle="tooltip" data-bs-original-title="{{ __('Convert To Deal') }}"></i></a>
                    </div>
                @endif
                ...
                <div class="action-btn bg-danger ms-2">
                    {!! Form::open(['method' => 'DELETE', 'route' => ['lead.destroy', $lead->id], 'id' => 'user-delete-form-' . $lead->id]) !!}
                    @csrf
                    <input name="_method" type="hidden" value="DELETE">
                    <button type="submit" class="mx-3 btn btn-sm d-inline-flex align-items-center show_confirm"
                        data-toggle="tooltip" title='Delete'>
                        <span class="text-white"> <i class="ti ti-trash" data-bs-toggle="tooltip" data-bs-original-title="{{ __('Delete') }}"></i></span>
                    </button>
                    </form>
                </div>
            </div>
                                                        ...
                                                        <div class="col-sm-auto mb-3 mb-sm-0">
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="div">
                                                                    ...
                                                                    {{-- <small
                                                                        class="text-muted">{{ number_format(\File::size(storage_path('uploads/lead_files/' . $file->file_path)) / 1572865, 2) . ' ' . __('MB') }}</small> --}}
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-auto text-sm-end d-flex align-items-center">
                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group mt-3">
                                        ...
                                        <textarea class="tox-target pc-tinymce-2" name="notes" id="pc_demo1" rows="8">{!! $lead->notes !!}</textarea>
                                    </div>
                                </div>
