...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active" aria-current="page">{{__('HR Admin')}}</li>
...
@section('action-btn')
    ...
    data-bs-whatever="{{__('Create New Termination')}}">
        ...
        {{-- <a href="#" data-url="{{ route('termination.create') }}" data-size="lg" data-ajax-popup="true" data-title="{{__('Create New Termination')}}" class="btn btn-sm btn-white btn-icon-only rounded-circle ml-4" data-toggle="tooltip">
                                ...
                                <tr>
                                    ...
                                    @if(\Auth::user()->type=='company')
                                        <td class="text-right">
                                            ...
                                            {{-- <a href="#" class="action-item" data-url="{{ route('termination.edit',$termination->id) }}" data-ajax-popup="true" data-title="{{__('Edit Termination')}}" data-toggle="tooltip" data-original-title="{{__('Edit')}}">
                                                <i class="far fa-edit"></i>
                                            </a>

                                            <a href="#!" class="action-item" data-toggle="tooltip" data-original-title="{{__('Delete')}}" data-confirm="Are You Sure?|This action can not be undone. Do you want to continue?" data-confirm-yes="document.getElementById('delete-form-{{$termination->id}}').submit();">
