...
<li class="breadcrumb-item active" aria-current="page"><a href="{{route('journal-entry.index')}}"> {{__('Journal Account')}} </a></li>
                ...
                <div class="item-section py-4">
                    <div class="row justify-content-between align-items-center">
                        <div class="col-md-12 d-flex align-items-center justify-content-between justify-content-md-end">
                                ...
                                <a href="#"  data-repeater-create=""  class="btn btn-sm btn-primary btn-icon m-1" data-bs-toggle="modal" data-target="#add-bank">
