...
@section('action-btn')
    ...
    data-bs-target="#exampleModal" data-url="{{ route('assets.file.import') }}"
    data-bs-whatever="{{__('Import asset CSV file')}}">
        <i class="ti ti-file-import text-white" data-bs-toggle="tooltip" data-bs-original-title="{{ __('Import') }}"></i>
    </a>

    <a href="#" class="btn btn-sm btn-primary btn-icon m-1" data-bs-toggle="modal"
    data-bs-target="#exampleModal" data-url="{{ route('account-assets.create') }}"
    data-bs-whatever="{{__('Create New Asset')}}">
                                    ...
                                    <td class="text-right">
                                        <div class="action-btn bg-info ms-2">
                                            <a href="#" class="mx-3 btn btn-sm d-inline-flex align-items-center" data-bs-toggle="modal"
                                                data-bs-target="#exampleModal" data-url="{{ route('account-assets.edit',$asset->id) }}"
                                        ...
                                        <div class="action-btn bg-danger ms-2">
                                            {!! Form::open(['method' => 'DELETE', 'route' => ['account-assets.destroy', $asset->id]]) !!}
                                                <a href="#!" class=" btn btn-sm d-inline-flex align-items-center show_confirm m-2">
