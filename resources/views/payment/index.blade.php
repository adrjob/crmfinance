                            ...
                            @foreach ($payments as $payment)
                                <tr>
                                    ...
                                    <th scope="row">
                                        <div class="media align-items-center">
                                            <div class="media-body">
                                                <a href="#" class="name h6 mb-0 text-sm">{{  Auth::user()->priceFormat($payment->amount)}}</a><br>
                                    ...
                                    <td>
                                        ...
                                        @endphp
                                        <a  href="{{ route('payment.receipt' , [$x,"$extension"]) }}"  data-toggle="tooltip" class="btn btn-sm btn-secondary btn-icon rounded-pill">
