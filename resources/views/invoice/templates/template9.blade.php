                            ...
                            <div data-v-7d9d14b5="" class="d-inner" style="border-right: 50px solid {{$color}};">
                                <div data-v-7d9d14b5="" class="row">
                                    <div data-v-7d9d14b5="" class="col-2"><h1 data-v-7d9d14b5="" class="fancy-title tu mb5" style="color: {{$color}};">{{__('INVOICE')}}</h1>
                                        ...
                                        <p class="ml-8" style="position: absolute; right: 0;"> {!! DNS2D::getBarcodeHTML(route('pay.invoice',\Illuminate\Support\Facades\Crypt::encrypt($invoice->id)), "QRCODE",2,2) !!}</p>   
                                    </div>
                                ...
                                <div data-v-363339a0="" class="d-table">
                                    <div data-v-363339a0="" class="d-table">
                                        ...
                                        <div class="d-table-tr" style="border-bottom:1px solid {{$color}};">
                                            ...
                                            <div class="d-table-td w-3">
                                                <pre data-v-f2a183a6="">{{ ($invoice->totalDiscount!=0)?\App\Models\Utility::priceFormat($settings,$invoice->totalDiscount):'-'}}</pre>
                                            </div>
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-summary">
                                                ...
                                                @endif
                                                    ...
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-value">{{\Auth::user()->priceFormat(($invoice->getTotal()-$invoice->getDue()-$invoice->invoiceCreditNote()))}}</div>
                                                    </div>
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        <div data-v-f2a183a6="" class="d-table-label">{{__('Due')}}:</div>
                                                        <div data-v-f2a183a6="" class="d-table-value">{{\Auth::user()->priceFormat($invoice->getDue())}}</div>
                                                    </div>
                                            </div>
                                        </div>
                                    </div>
