                                            ...
                                            <div>
                                                <div class="user-group1">
                                                    @if(\Auth::user()->type!='client')
                                                        <img alt="" @if(!empty($invoice->clients) && !empty($invoice->clients->avatar)) src="{{$profile.'/'.$invoice->clients->avatar}}" @else  avatar="{{!empty($invoice->clients)?$invoice->clients->name:''}}" @endif data-toggle="tooltip" data-title="{{!empty($invoice->clients)?$invoice->clients->name:''}}" class="avatar  rounded-circle">
                                                    @endif
                                                </div>
                                            </div>
