...
@section('action-btn')
    @if(\Auth::user()->type=='company')
        ...
        data-bs-whatever="{{__('Create New Filed')}}"data-bs-toggle="tooltip" title="Create New Filed" 
        data-bs-original-title="{{__('Create New Filed')}}"> 
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <div class="action-btn bg-info ms-2">
                                            ...
                                            data-bs-whatever="{{__('Edit Field')}}" data-bs-toggle="tooltip" title="{{ __('Edit Field') }}" 
                                            data-bs-original-title="{{__('Edit Field')}}"> <span class="text-white"> <i
