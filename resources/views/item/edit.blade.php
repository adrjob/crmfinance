        ...
        <div class="form-group">
            ...
            <div class="row">
                <div class="form-check col-md-6">
                    <input class="form-check-input" type="radio" name="type" value="product" @if($item->type=='product') checked @endif
                        id="flexCheckDefault">
                ...
                <div class="form-check col-md-6">
                    <input class="form-check-input" type="radio" name="type" value="service" @if($item->type=='service') checked @endif
