...
@section('action-btn')
    ...
    data-bs-target="#exampleModal" data-url="{{ route('department.create') }}"
    data-bs-whatever="{{__('Create New Department')}}"> <span class="text-white"> 
                                    ...
                                    <td class="action text-right">
                                        <div class="action-btn bg-info ms-2">
                                            <a href="#" class="mx-3 btn btn-sm d-inline-flex align-items-center" data-bs-toggle="modal"
                                                data-bs-target="#exampleModal" data-url="{{ route('department.edit',$department->id) }}"
                                                data-bs-whatever="{{__('Edit Department')}}" > <span class="text-white"> <i
