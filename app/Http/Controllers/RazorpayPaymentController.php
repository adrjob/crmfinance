            ...
            // {
                ...
                if($response->status == 'authorized')
                {
                    ...
                    if(isset($settings['payment_create_notification']) && $settings['payment_create_notification'] ==1){
                        ...
                        $msg = __('New payment of ').$amt.' '.__('created for ').$user->name.__(' by Razorpay').'.';
                        //dd($msg);
                        Utility::send_slack_msg($msg); 
                           
                    }
                     if(isset($settings['telegram_payment_create_notification']) && $settings['telegram_payment_create_notification'] ==1){
                            $resp = __('New payment of ').$amt.' '.__('created for ').$user->name.__(' by Razorpay').'.';
                    ...
                    {
                         $message = __('New payment of ').$amount.' '.__('created for ').$user->name.__(' by Razorpay').'.';
                         //dd($message);
