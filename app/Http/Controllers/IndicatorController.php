...
class IndicatorController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('indicator.create', compact('performance', 'brances', 'departments'));
    }
    ...
    public function edit(Indicator $indicator)
    {
        ...
        return view('indicator.edit', compact('performance', 'brances', 'departments', 'ratings','indicator'));
    }
