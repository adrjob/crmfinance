        ...
        $defaultTemplate = [
            ...
            'send_estimation' => [
                ...
                'lang' => [
                    ...
                    'pt' => '<p style="line-height: 28px; font-family: Nunito, " segoe="" ui",="" arial;="" font-size:="" 14px;"=""><span style="font-size: 14px; font-family: sans-serif;">Olá,</span><br style="font-size: 14px; font-family: sans-serif;"><span style="font-size: 14px; font-family: sans-serif;">Nova estimativa foi atribuída a você.</span><br></p><p style="line-height: 28px; font-family: Nunito, " segoe="" ui",="" arial;="" font-size:="" 14px;"=""><b>Nome da estimativa</b>: {estimation_id}</p><p style="line-height: 28px; font-family: Nunito, " segoe="" ui",="" arial;="" font-size:="" 14px;"=""><b>Cliente de estimativa</b>&nbsp;: {estimation_client}</p><p style="line-height: 28px; font-family: Nunito, " segoe="" ui",="" arial;="" font-size:="" 14px;"=""><b>Categoria de estimativa</b>&nbsp;: {estimation_category}</p><p style="line-height: 28px; font-family: Nunito, " segoe="" ui",="" arial;="" font-size:="" 14px;"=""><b>Data de emissão da estimativa</b>&nbsp;: {estimation_issue_date}</p><p style="line-height: 28px; font-family: Nunito, " segoe="" ui",="" arial;="" font-size:="" 14px;"=""><b>Data de expiração da estimativa</b>&nbsp;: {estimation_expiry_date}<br><b>Status da estimativa</b>&nbsp;: {estimation_status}</p><p></p>',
                ],
            ],
            'create_project' => [
            ...
            'create_contract' => [
                ...
                'lang' => [
                    ...
                    'pt' => '<p><b>Oi</b>&nbsp;{contract_client}</p><pre class="tw-data-text tw-text-large XcVN5d tw-ta" data-placeholder="Translation" id="tw-target-text" dir="ltr" style="unicode-bidi: isolate; line-height: 36px; border: none; padding: 2px 0.14em 2px 0px; position: relative; margin-top: -2px; margin-bottom: -2px; resize: none; overflow: hidden; width: 277px; overflow-wrap: break-word;"><span lang="pt">Por favor ache a  {contract_subject}.</span></pre><p><b>Descrição</b>: {contract_description}</p><pre class="tw-data-text tw-text-large XcVN5d tw-ta" data-placeholder="Translation" id="tw-target-text" dir="ltr" style="unicode-bidi: isolate; line-height: 36px; border: none; padding: 2px 0.14em 2px 0px; position: relative; margin-top: -2px; margin-bottom: -2px; resize: none; overflow: hidden; width: 277px; overflow-wrap: break-word;"><span lang="pt">Ansioso para ouvir de você.</span></pre><p><b>Atenciosamente</b>,,<br>{app_name}</p>',
                ],
            ],
        ];
